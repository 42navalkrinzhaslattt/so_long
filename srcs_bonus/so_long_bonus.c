...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/12/10 16:43:11 by nam-vu            #+#    #+#             */
/*   Updated: 2023/12/10 16:43:11 by nam-vu           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	init_textures(t_game *game)
{
	...
	game->txt.z = mlx_xpm_file_to_image(game->mlx, "textures/z.xpm", &a, &a);
	if (!game->txt.w || !game->txt.f || !game->txt.d
		|| !game->txt.l || !game->txt.r || !game->txt.u
		|| !game->txt.c || !game->txt.e || !game->txt.z)
		return (0);
	return (1);
}
